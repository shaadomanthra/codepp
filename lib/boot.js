...
function payload($query) {
  ...
  if ($lang == "java")
    ...
    $payload =
      '{"language":"php","command":"php main.php ' +
      $input +
    ...
    $payload =
      '{"language":"swift","command":"swift main.swift ' +
      $input +
      '", "files": [{"name": "main.swift", "content": ' +
      $code +
      "}]}";
  else if ($lang == "golang")
    $payload =
      ...
      $input +
      '", "files": [{"name": "main.go", "content": ' +
      $code +
      "}]}";
  else if ($lang == "ruby")
    $payload =
      '{"language":"ruby","command":"ruby main.rb ' +
      $input +
      '", "files": [{"name": "main.rb", "content": ' +
      $code +
      "}]}";
  else if ($lang == "bash")
    $payload =
      '{"language":"bash","command":"bash main.sh ' +
      $input +
